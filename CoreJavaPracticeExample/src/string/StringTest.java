...
public class StringTest implements Comparator {
	...
	public static void main(String str[]) {
		...
		String stt1 = "Javatpoint";  
        String stt2 = stt1.intern();  
        String stt3 = new String("Javatpoint");  
        String stt4 = stt3.intern();          
        System.out.println(stt1==stt2); // True  
        System.out.println(stt1==stt3); // False  
        System.out.println(stt1==stt4); // True       
        System.out.println(stt2==stt3); // False  
        System.out.println(stt2==stt4); // True        
        System.out.println(stt3==stt4); // False  
		...
		String astr1 = "astr";
		String astr2 = new String("astr");
		System.out.println("senario1-- "+astr1.equals(astr2));
		System.out.println("senario2kjk-- "+astr1==astr2);
		String astr3 = new String("astr");
		System.out.println("senario2kjk-- "+astr1==astr3);
		String astr4 = astr3.intern();
		System.out.println("senario2kjk-- "+astr1==astr4);
		...
		StringBuffer sb8 = new StringBuffer("We are comparing the content with a StringBuffer content");
		/**
		...
		System.out.println("First occurance of char 's' from 4th index onwards : " + str1.indexOf('s', 4));
		 ...
		 */
		System.out.println("first occurance of char 's' from 24th index backwards: " + str1.lastIndexOf('s', 24));
		System.out.println(
				"First occurance of String \"this\" from 26th index backwards: " + str1.lastIndexOf("this", 26));

		String str11 = "This is an example string.";
		System.out.println("Is this string starts with \"This\"? " + str11.startsWith("This"));
		System.out.println("Is this string starts with \"is\"? " + str11.startsWith("is"));
		System.out.println("Is this string starts with \"is\" after index 5? " + str11.startsWith("is", 5));
		...
		// http://www.java2novice.com/java_string_examples

		String str15 = "This is an example string";
		System.out.println("Replace char 's' with 'o':" + str15.replace('s', 'o'));

		System.out.println("Replace first occurance of string\"is\" with \"ui\":" + str15.replaceFirst("is", "ui"));

		System.out.println("Replacing \"is\" every where with \"no\":" + str15.replaceAll("is", "no"));
		...
		// How to match a format in string using regular expression? - See more at:
		// http://www.java2novice.com/java_string_examples/regular_expression/#sthash.pk8E5fWW.dpuf
		...
		/*
		 * StringBuffer doesn't override equals(); its equals() method is the one
		 * inherited from java.lang.Object, which returns true if and only if "==" would
		 * be true. String, on the other hand, does override equals(); its definition
		 * returns true of the two objects contain the same sequence of characters.
		 */
